...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><?=$kontrol[0]["baslik"]?>Duzenleme Sayfası</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="card">
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?= SITE ?>liste/<?= $kontrol[0]["tablo"] ?>" class="btn btn-info"  style="float:right; margin-bottom:10px; margin-left: 10px;"><i class="fas fa-bars"></i> LISTE</a>
                        ...
                        <div class="card-body card card-primary">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Baslık</label>
                                        <input type="text" class="form-control" placeholder="Baslık ..." name="baslık" value="<?=stripslashes($veri[0]["baslik"])?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Acıklama</label>
                                        <textarea class="textarea" placeholder="Acıklama Alanıdır" name="metin"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Description ..." value="<?=stripslashes($veri[0]["description"])?>"
                                               name="description">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Sıra No</label>
                                        <input type="number" class="form-control" style="width: 100px" placeholder="Sıra No ..." value="<?=stripslashes($veri[0]["sirano"])?>"
                                               name="sirano">
                                    </div>
                                </div>
                            </div>
